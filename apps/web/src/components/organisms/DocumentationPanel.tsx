    ...
    <div className="space-y-4 md:space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 md:p-6">
        ...
        <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div>
            <dt className="text-gray-500 dark:text-gray-400">{t('documentation.article')}</dt>
            <dd className="font-medium mt-0.5">{dokumentation.artikelBezeichnung}</dd>
          </div>
          <div>
            <dt className="text-gray-500 dark:text-gray-400">{t('documentation.timestamp')}</dt>
            <dd className="mt-0.5">{new Date(dokumentation.zeitstempel).toLocaleString(dateLocale)}</dd>
          </div>
          <div>
            <dt className="text-gray-500 dark:text-gray-400">{t('documentation.user')}</dt>
            <dd className="mt-0.5">{dokumentation.benutzer}</dd>
          </div>
          <div>
            <dt className="text-gray-500 dark:text-gray-400">{t('documentation.classification')}</dt>
            <dd className="mt-0.5">
              <ClassificationBadge
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('documentation.reasoning')}</h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 md:p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">{compliancePruefung.schwellenwertKategorie}</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 md:p-6">
        ...
        <code className="text-xs bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-3 rounded-lg block break-all font-mono">
