          ...
          {frameworkAlternative && (
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="text-sm text-gray-500 mb-1">{selectedArticle.marketplace}</div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div className="p-6">
          <p className="font-medium text-gray-900 mb-3">{articleName}</p>
...
function ChecklistItem({ checked, onChange, label }: ChecklistItemProps) {
  return (
    <label className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 cursor-pointer border border-gray-200 transition-colors">
      <input
        type="checkbox"
        checked={checked}
        onChange={onChange}
